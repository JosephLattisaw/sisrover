...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ChangeNotifierProvider<c_api.CamClientCAPI>(
          create: (context) => c_api.CamClientCAPI(),
...
/*class MyApp extends StatelessWidget {
  final String imageFilePath = "/home/efsi/Desktop/jeep.png";
  final String imageDataPath = "/home/efsi/Desktop/symlink.png";
  ...
  Image loadFileImage() {
    return Image(
      image: FileImage(loadFile()),
    );
  }

  Uint8List loadData() {
    File file = File(imageDataPath);
  ...
  Image loadDataImage() {
    return Image(
      image: MemoryImage(loadData()),
    );
  }

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<c_api.CamClientCAPI>(context, listen: true);
    return MaterialApp(
      home: Consumer<dumbprovider>(
...
/*class ConnectedWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Text('${provider.getConnected()}');
  }
}*/
